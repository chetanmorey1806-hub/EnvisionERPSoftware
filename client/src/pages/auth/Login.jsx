  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-2 bg-white dark:bg-slate-950">
      ...
      <aside className="hidden lg:flex flex-col justify-between p-10 bg-sky-50 dark:bg-sky-950/30 relative overflow-hidden">
        ...
        <div className="absolute -top-24 -right-24 h-72 w-72 rounded-full bg-blue-300/40 dark:bg-blue-500/10 blur-3xl pointer-events-none animate-glow" />
        <div
        ...
        <div className="relative animate-fade-up" style={{ animationDelay: '80ms' }}>
          ...
          <p className="text-[10px] font-bold uppercase tracking-widest text-blue-900/50 dark:text-blue-300/60 mt-3">
        ...
        <ul className="relative flex flex-wrap gap-x-6 gap-y-2 stagger">
          {HIGHLIGHTS.map((h, i) => (
            <li
              key={h.label}
              style={{ '--i': i + 6 }}
              className="flex items-center gap-2 text-[11px] font-semibold text-blue-900/70 dark:text-blue-200/70"
            >
      ...
      {/* ------------------------------------------------------- Form panel */}
      <main className="flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 bg-linear-to-br from-slate-900 via-blue-950 to-slate-900 lg:bg-none lg:bg-white dark:lg:bg-slate-950">
